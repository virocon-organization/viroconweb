...
# These settings are required for Sphinx to work with Django.
# Thanks to: https://stackoverflow.com/questions/36228537/django-settings-
# module-not-defined-when-building-sphinx-documentation
os.environ['DJANGO_SETTINGS_MODULE'] = 'viroconweb.settings'
import django
django.setup()
...
htmlhelp_basename = 'viroconwebdoc'
...
latex_documents = [
    (master_doc, 'viroconweb.tex', 'viroconweb Documentation',
     'viroconweb', 'manual'),
]
...
man_pages = [
    (master_doc, 'viroconweb', 'viroconweb Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'viroconweb', 'viroconweb Documentation',
     author, 'viroconweb', 'One line description of project.',
     'Miscellaneous'),
]
